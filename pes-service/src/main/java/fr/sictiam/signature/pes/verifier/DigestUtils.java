...
public class DigestUtils
{
  ...
  public static byte[] xmlDigest(byte[] data, String xmlDigesterName)
  ...
  public static byte[] xmlDigest(InputStream inputStream, String xmlDigesterName)
    throws NoSuchAlgorithmException, IOException
  {
    String javaDigester = (String)JAVA_DIGESTER_NAME_BY_XML_DIGESTER_NAME.get(xmlDigesterName);
...
/* Location:
 * Qualified Name:     com.axyus.signature.pes.verifier.DigestUtils
