...
public class PesRetourService {
    ...
    public List<PesRetour> getAllWithQuery(String filename, LocalDate creationFrom, LocalDate creationTo, String currentLocalAuthUuid, Integer limit, Integer offset) {
        ...
        List<Predicate> predicates = getQueryPredicates(builder, pesRetourRoot, filename, creationFrom, creationTo, currentLocalAuthUuid);
    ...
    public Long countAllWithQuery(String filename, LocalDate creationFrom, LocalDate creationTo, String currentLocalAuthUuid) {
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
    ...
    private List<Predicate> getQueryPredicates(CriteriaBuilder builder, Root<PesRetour> pesRetourRoot, String filename,
        ...
        if (StringUtils.isNotBlank(filename)) {
            ...
            attachmentJoin.on(builder.like(builder.lower(attachmentJoin.get("filename")), "%" + filename.toLowerCase() + "%"));
        }
