 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}depotPESAllerStruct" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "depotPESAllerResponse")
public class DepotPESAllerResponse {

    @XmlElement(required = true)
    protected String statusCode;
    @XmlElement(required = true)
    protected List<DepotPESAllerStruct> retour;
     ...
     * {@link DepotPESAllerStruct }
     *
     *
     */
    public List<DepotPESAllerStruct> getRetour() {
        if (retour == null) {
            retour = new ArrayList<DepotPESAllerStruct>();
        }
        return this.retour;
    }
