...
@XmlType(name = "", propOrder = { "sessionId", "idPesAller" })
@XmlRootElement(name = "getDetailsPESAllerRequest")
public class GetDetailsPESAllerRequest {

    @XmlElement(required = true)
    protected String sessionId;
    @XmlElement(name = "IdPesAller", required = true)
