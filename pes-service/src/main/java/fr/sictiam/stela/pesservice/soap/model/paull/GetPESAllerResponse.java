 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}getPESAllerStruct" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getPESAllerResponse")
public class GetPESAllerResponse {

    @XmlElement(required = true)
    protected String statusCode;
    @XmlElement(required = true)
    protected List<GetPESAllerStruct> retour;
     ...
     * {@link GetPESAllerStruct }
     *
     *
     */
    public List<GetPESAllerStruct> getRetour() {
        if (retour == null) {
            retour = new ArrayList<GetPESAllerStruct>();
        }
        return this.retour;
    }
