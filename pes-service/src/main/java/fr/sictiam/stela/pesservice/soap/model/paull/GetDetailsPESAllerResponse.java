 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}getDetailsPESAllerStruct" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getDetailsPESAllerResponse")
public class GetDetailsPESAllerResponse {

    @XmlElement(required = true)
    protected String statusCode;
    @XmlElement(required = true)
    protected List<GetDetailsPESAllerStruct> retour;
     ...
     * {@link GetDetailsPESAllerStruct }
     *
     *
     */
    public List<GetDetailsPESAllerStruct> getRetour() {
        if (retour == null) {
            retour = new ArrayList<GetDetailsPESAllerStruct>();
        }
        return this.retour;
    }
