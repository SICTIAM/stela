...
@Service
public class AwsS3 implements StorageDriver {
    ...
    public AwsS3(Environment environment) {

        this.environment = environment;


        String region = environment.getProperty("application.storage.awss3.region");
        if (region == null)
            throw new StorageException("Missing configuration property application.storage.awss3.region");

        bucket = environment.getProperty("application.storage.awss3.bucket");
        if (bucket == null)
            throw new StorageException("Missing configuration property application.storage.awss3.bucket");

        String accessKey = environment.getProperty("application.storage.awss3.accesskey");
        if (accessKey == null)
            throw new StorageException("Missing configuration property application.storage.awss3.accesskey");

        String secretKey = environment.getProperty("application.storage.awss3.secretkey");
        if (secretKey == null)
            throw new StorageException("Missing configuration property application.storage.awss3.secretkey");
