...
public class ProcurationCancelledEvent extends ApplicationEvent {

    private Convocation convocation;

    private RecipientResponse recipientResponse;

    public ProcurationCancelledEvent(Object source, Convocation convocation, RecipientResponse recipientResponse) {
        super(source);
