 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}getDocumentStruct" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetDocumentResponse {
    ...
    @XmlElement(required = true)
    protected List<GetDocumentStruct> retour;
     ...
     * {@link GetDocumentStruct }
     * 
     * 
     */
    public List<GetDocumentStruct> getRetour() {
        if (retour == null) {
            retour = new ArrayList<GetDocumentStruct>();
        }
        return this.retour;
    }
