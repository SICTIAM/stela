 ...
 *         &lt;element name="idActe" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getDetailsActeRequest")
public class GetDetailsActeRequest {
    ...
    /**
     * Obtient la valeur de la propriété idActe.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété idActe.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
