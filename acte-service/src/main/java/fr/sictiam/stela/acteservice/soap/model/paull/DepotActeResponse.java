 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}depotActeStruct" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "depotActeResponse")
public class DepotActeResponse {

    @XmlElement(required = true)
    protected String statusCode;
    @XmlElement(required = true)
    protected List<DepotActeStruct> retour;
     ...
     * {@link DepotActeStruct }
     * 
     * 
     */
    public List<DepotActeStruct> getRetour() {
        if (retour == null) {
            retour = new ArrayList<DepotActeStruct>();
        }
        return this.retour;
    }
