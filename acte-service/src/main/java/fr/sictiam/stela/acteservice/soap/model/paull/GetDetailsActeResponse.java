 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}getDetailsActeStruct" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getDetailsActeResponse")
public class GetDetailsActeResponse {

    @XmlElement(required = true)
    protected String statusCode;
    @XmlElement(required = true)
    protected List<GetDetailsActeStruct> retour;
     ...
     * This is why there is not a <CODE>set</CODE> method for the retour property.
     * 
     * <p>
     ...
     * {@link GetDetailsActeStruct }
     * 
     * 
     */
    public List<GetDetailsActeStruct> getRetour() {
        if (retour == null) {
            retour = new ArrayList<GetDetailsActeStruct>();
        }
        return this.retour;
    }
