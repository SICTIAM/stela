 ...
 *         &lt;element name="retour" type="{http://www.processmaker.com}getAnnexesStruct1" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getAnnexesResponse")
public class GetAnnexesResponse {

    @XmlElement(required = true)
    protected String statusCode;
    @XmlElement(required = true)
    protected List<GetAnnexesStruct1> retour;
     ...
     * {@link GetAnnexesStruct1 }
     * 
     * 
     */
    public List<GetAnnexesStruct1> getRetour() {
        if (retour == null) {
            retour = new ArrayList<GetAnnexesStruct1>();
        }
        return this.retour;
    }
