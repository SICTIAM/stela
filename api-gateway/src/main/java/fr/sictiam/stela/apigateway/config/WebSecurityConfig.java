    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.addFilterBefore(oasisAuthenticationFilter(), AbstractPreAuthenticatedProcessingFilter.class)
                .authorizeRequests()
                    ...
                    .antMatchers("/externalws/**/classic/*/services/api/**").permitAll()
                    .antMatchers("/externalws/**/services/wsdl2/**").permitAll()
                    .antMatchers("/api/**").authenticated().and()
                .csrf()
                    .ignoringAntMatchers("/api/admin/ozwillo/**")
                    .ignoringAntMatchers("/api/*/ws/**")
                    .ignoringAntMatchers("/externalws/**/classic/*/services/api/**")
                    .ignoringAntMatchers("/externalws/**/services/wsdl2/**").and()
                .logout()
