    ...
    render() {
        ...
        return (
            <Page title={t('admin.modules.acte.migration.title')}>
                ...
                <Segment>
                    <h2 className='secondary'>{t('admin.modules.acte.migration.additional_options.title')}</h2>
                    <FieldInline htmlFor='email' label={t('admin.modules.acte.migration.additional_options.email')}>
                        <Input id='email'
                            placeholder={`${t('api-gateway:agent.email')}...`}
                            value={this.state.form.email}
                            onChange={this.onFormChange} />
                    </FieldInline>
                    <FieldInline htmlFor='siren' label={t('admin.modules.acte.migration.additional_options.siren')}>
                        <Input id='siren'
                            placeholder={`${t('api-gateway:local_authority.siren')}...`}
                            value={this.state.form.siren}
                            onChange={this.onFormChange} />
                    </FieldInline>
                    <FieldInline htmlFor='month' label={t('admin.modules.acte.migration.additional_options.month')}>
                        <Input id='month'
                            type='number'
                            min='1'
