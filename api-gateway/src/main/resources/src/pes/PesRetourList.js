  ...
  render() {
    ...
    const attachmentLink = pesRetour => (
      <a
        id="attachment"
        target="_blank"
        href={`/api/pes/pes-retour/${pesRetour.uuid}/file`}
      >
        {pesRetour.attachment.filename}
      </a>
    );
    const metaData = [
      ...
      },
      {
        property: '_self',
        displayed: true,
        displayName: t('pes.fields.attachment'),
        searchable: false,
        displayComponent: attachmentLink
      }
    ];
        ...
        <Segment>
          ...
          >
            <Form onSubmit={this.submitForm}>
              <FormFieldInline
                htmlFor="filename"
                label={t('pes.fields.attachment')}
              >
                <input
                  id="filename"
                  value={search.objet}
                  onChange={e =>
                    this.handleFieldChange('filename', e.target.value)
                  }
                />
              </FormFieldInline>
              <FormFieldInline
