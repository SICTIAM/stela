    ...
    render() {
        ...
        return (
            <Switch>
                ...
                <AuthRoute path="/:localAuthoritySlug/admin/ma-collectivite/convocation" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={ConvocationLocalAuthorityParams} menu={AdminMenuBar} admin={true} />
                <AuthRoute path="/:localAuthoritySlug/admin/convocation/type-assemblee/nouveau" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={AssemblyTypeConfig} menu={AdminMenuBar} admin={true} />
                <AuthRoute path="/:localAuthoritySlug/admin/convocation/type-assemblee/liste-type-assemblee/:uuid" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={AssemblyTypeConfig} menu={AdminMenuBar} admin={true} />
                <AuthRoute path="/:localAuthoritySlug/admin/convocation/type-assemblee/liste-type-assemblee" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={AssemblyTypeList} menu={AdminMenuBar} admin={true} />
                <AuthRoute path="/:localAuthoritySlug/admin/convocation/destinataire/nouveau" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={RecipentConfig} menu={AdminMenuBar} admin={true} />
                <AuthRoute path="/:localAuthoritySlug/admin/convocation/destinataire/liste-destinataires/:uuid" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={RecipentConfig} menu={AdminMenuBar} admin={true} />
                <AuthRoute path="/:localAuthoritySlug/admin/convocation/destinataire/liste-destinataires" {...params} allowedRights={['CONVOCATION_ADMIN', 'LOCAL_AUTHORITY_ADMIN']} component={RecipientsList} menu={AdminMenuBar} admin={true} />
