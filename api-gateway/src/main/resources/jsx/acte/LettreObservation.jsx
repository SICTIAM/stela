...
class LetteObservation extends Component {
    ...
    sendResponse = (reponseOrRejet) => {
        ...
        fetchWithAuthzHandling({ url: `/api/acte/${this.props.acteUuid}/lettre-observation/${reponseOrRejet}`, method: 'POST', body: data, context: this.context })
            .then(checkStatus)
            .then(() => {
                this.context._addNotification(notifications.acte.lettreObservationAsked)
